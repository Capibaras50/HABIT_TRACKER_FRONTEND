...
export default function Habits(): React.JSX.Element {
    ...
    // Quick Add State - Subtitle removed
    ...
    const formatDuration = (timeStr: string) => {
        // Expected format: "30", "30 min", "1h", etc. User said "time is always in minutes" so input is likely a number string.
        // We will try to parse it.
        const minutes = parseInt(timeStr)
        if (isNaN(minutes)) return timeStr // Fallback if not a number
    ...
    const toggleHabitCompletion = async (habit: Habit) => {
        ...
        // Handle both formats: short codes (L, M, X) and full names (Lunes, Martes, Miercoles)
        ...
        // If completing, open difficulty prompt
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            await api.updateHabit(editingHabitId, { ...changes, type: 'weekday', days: editRowData.days })
