        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: 'var(--bg-app)' }}>
            <Card style={{ width: '400px', padding: '2rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h1 style={{ fontSize: '2rem', fontWeight: 700, margin: 0 }}>Bienvenido</h1>
                    <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>Inicia sesión para continuar</p>
                </div>
                ...
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div style={{ textAlign: 'center', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                        ¿No tienes cuenta? <span style={{ color: 'var(--accent-primary)', cursor: 'pointer', fontWeight: 600 }} onClick={() => navigate('/register')}>Regístrate</span>
                    </div>
                </form>
            </Card>
        </div>
